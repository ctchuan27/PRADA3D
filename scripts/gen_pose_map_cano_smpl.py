...
if __name__ == '__main__':
    smplx_parm_path = '/home/enjhih/Tun-Chuan/GaussianAvatar/default_dataset/m3c_processed/test' # path to the folder that include smpl params
    ...
    #save_npz(smplx_parm_path, 256, uv_template_fn)
    #save_npz_smplx(smplx_parm_path, 512, uv_template_fn_smplx)
